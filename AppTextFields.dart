  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        filled: true,
        hintStyle: TextStyle(
          color: fillColor != null ? AppColor.white : AppColor.labelTextFieldsColor,
        ...
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(fillColor != null ? 20.spMin : AppSize.textFieldsBorderRadius),
          borderSide: BorderSide(
            color: AppColor.textFieldBorderColor,
            width: fillColor == null ? AppSize.textFieldsBorderWidth : 2.spMin,
          ),
        ),
